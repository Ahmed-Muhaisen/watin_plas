...
<div class="text-start mt-5 border p-5 w-50 m-auto">
    <h1 class="m-5 mt-0 text-center">Register page</h1>
    ...
    <form action="register-post" method="post" class="">
        ...
        <a href="{{ route("login") }}" class="">I have username</a>
        <br>
<button type="submit" class= "m-auto mt-3 p-3 px-5 btn btn-info d-block" >Register</button>
</form>
